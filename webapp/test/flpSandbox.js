		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Pruebas",
									"targetURL": "#Pruebaprueba-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Pruebaprueba-display": {
								"semanticObject": "Pruebaprueba",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Prueba.prueba",
									"url": sap.ui.require.toUrl("Prueba/prueba")
								}
							}
						}
					}
